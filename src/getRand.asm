...
get_rand:
    ...
    mov [question_size], EAX ; save max for modulo
    rdtsc ; get CPU clock for random seed

    xor EDX, EDX ; clear EDX, to only use lower 32 bits

    mov ECX, [question_size] ; load max
    div ECX ; divide, remainder in EDX

    mov EAX, EDX ; return remainder

    ret ; done, random in EAX